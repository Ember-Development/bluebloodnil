...
async function main() {
  ...
  console.log(`✅ Created athlete 1: ${athlete1.email} (User ID: ${athlete1.id})`);
  ...
  console.log(`✅ Created athlete 2: ${athlete2.email} (User ID: ${athlete2.id})`);
  ...
  console.log(`✅ Created athlete 3: ${athlete3.email} (User ID: ${athlete3.id})`);
    ...
    data: {
      ...
      athlete: {
        create: {
          ...
          avatarUrl: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?auto=format&fit=crop&q=80&w=400',
          nilScore: 85,
  ...
  console.log(`✅ Created athlete 4 (complete): ${athlete4.email} (User ID: ${athlete4.id})`);
