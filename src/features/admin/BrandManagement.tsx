...
export function BrandManagement() {
  ...
  const handleDeleteBrand = async (id: string) => {
    if (!confirm('Are you sure you want to delete this brand? This will also delete all associated campaigns.')) return;
    try {
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <small style={{ 
                ...
                Recommended: Square image, minimum 120x120px (logos display at 28-80px depending on location)
              </small>
              {formData.logoUrl && (
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', gap: 'var(--space-md)', alignItems: 'center', flexWrap: 'wrap' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', alignItems: 'center' }}>
                      ...
                      />
                      <span style={{ fontSize: '0.7rem', color: 'var(--color-muted)' }}>Member Card (80px)</span>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', alignItems: 'center' }}>
                      <img
                        src={formData.logoUrl}
                      ...
                      />
                      <span style={{ fontSize: '0.7rem', color: 'var(--color-muted)' }}>Campaign Card (48px)</span>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', alignItems: 'center' }}>
                      <img
                        src={formData.logoUrl}
                      ...
                      />
                      <span style={{ fontSize: '0.7rem', color: 'var(--color-muted)' }}>Feed Card (28px)</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              <tr key={brand.id}>
                ...
                <td>
                  <div className="table-actions">
                    <button className="btn-action" onClick={() => startEdit(brand)}>
                      Edit
                    </button>
                    <button
