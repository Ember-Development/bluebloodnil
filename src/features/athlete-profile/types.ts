...
export interface SocialProfile {
  ...
  handle: string;
  followers: number;
  avgEngagementRate?: number | null; // Make it optional/nullable
  avgViews?: number | null; // Make it optional/nullable
...
along for drills, mindset tips, and behind-the-scenes from tournaments across Texas.`,
  ...
  scenarioIdeas: [
    ...
    },
    {
      ...
      idealBrands:
        "Indoor facilities, trainers, strength & conditioning providers.",
    },
    {
      id: "restaurant",
      ...
      idealBrands:
        "Family restaurants, smoothie/coffee shops, local retailers.",
    },
  ],
  campaigns: [
    {
    ...
    },
    {
      ...
      objective:
        "Drive team & family traffic during a major Houston tournament",
      deliverables: [
  ...
  todos: [
    {
      ...
      description:
        "Upload the 3 TikTok videos and 2 Instagram posts for review. Ensure all content follows brand guidelines.",
    ...
    },
    {
      ...
      description:
        "Update your media kit with latest social media statistics and recent campaign results.",
      assignedBy: "Admin Sarah",
    ...
    },
    {
      ...
      description:
        "Review the contract terms for the summer promotion campaign and sign if approved.",
    ...
    },
    {
      ...
      description:
        "Submit receipts for travel and materials used during the clinic campaign.",
      assignedBy: "Admin Sarah",
