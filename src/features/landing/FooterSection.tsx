...
const footerLinks = [
  ...
  {
    title: "Legal",
    links: ["Terms of Service", "Privacy Policy", "NIL Disclosure"],
  },
];
  ...
  return (
    ...
    >
      <div style={containerStyle}>
                ...
                {block.links.map((link) => (
                  <li key={link}>
                    <a
                      ...
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.color = colors.carolina)
                      }
                      onMouseLeave={(e) =>
                        (e.currentTarget.style.color = colors.slate500)
                      }
                    >
                      {link}
                    </a>
        ...
        >
          <p style={{ margin: 0 }}>
            © 2025 Bombers Fastpitch. All rights reserved.
          </p>
          <p style={{ margin: 0 }}>Built for the game. Built by EMBER.</p>
        </div>
      </div>
    </footer>
  );
