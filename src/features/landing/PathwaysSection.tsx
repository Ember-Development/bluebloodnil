      ...
      <div style={{ ...containerStyle, position: 'relative', zIndex: 2 }}>
        ...
        >
          <div style={{ position: 'sticky', top: 120 }}>
            ...
            <div style={{ height: 4, width: 96, background: colors.carolina, margin: '16px 0' }} />
            <p
              style={{
            ...
            >
              Instead of random deals, BlueBloods follows a four-stage journey from first Bombers reps to a college collective meeting.
            </p>
          </div>
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: colors.white,
          borderLeft: hovered ? `4px solid ${colors.carolina}` : '4px solid rgba(15,23,42,0.08)',
          borderRadius: '0 18px 18px 0',
          padding: '20px 24px',
          boxShadow: hovered ? '0 28px 40px rgba(15,23,42,0.12)' : '0 18px 30px rgba(15,23,42,0.08)',
      ...
      >
        ...
        >
          ...
          <ChevronRight size={18} color={hovered ? colors.carolina : colors.slate400} />
        </div>
        <h3
          style={{
            margin: '0 0 12px',
        ...
        <p style={{ margin: 0, color: colors.slate600, lineHeight: 1.6 }}>{step.desc}</p>
          ...
          {step.tags.map((tag) => (
            <span
              ...
              style={{
                ...
                alignItems: 'center',
                gap: 6,
                background: hovered ? colors.slate900 : 'rgba(148,163,184,0.15)',
